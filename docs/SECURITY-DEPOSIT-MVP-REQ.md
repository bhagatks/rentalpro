...
> **Partner review:** Confirm native CAP-4 trust sub-ledger approach with partner (P0). **Attorney review (Mandatory items):** [`ATTORNEY-REVIEW-CHECKLIST.md`](./ATTORNEY-REVIEW-CHECKLIST.md) §5.
