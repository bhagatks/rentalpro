...
| Native mobile (Phase 2 Non-goal) | Partner discussion → [`MOBILE-APP-PHASE2-GAP-DISCUSSION.md`](./MOBILE-APP-PHASE2-GAP-DISCUSSION.md); do not reopen Non-goal until locked |
